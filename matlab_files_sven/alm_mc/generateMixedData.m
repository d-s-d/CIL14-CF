function [ data, modData, g, attacker_rows ] = generateMixedData( user, hotel, groups, attackers ,sparse )
...
victims = randperm(user);
attacker_rows = victims(1:attackers);
if (attackers < user && attackers > 0)
    for a=1:attackers
        fake_data = zeros(1,hotel);
