...
\addplot [mark=square*,blue,solid] table {data/Sparse/ALM0.dat};
\addplot [mark=square*,green,solid]	table {data/Sparse/RPCA0.dat};
\addplot [mark=square*,red,solid] table {data/Sparse/SVD0.dat};
\addplot [mark=o,blue,dotted] table {data/Sparse/ALM100.dat};
\addplot [mark=o,blue,dotted] table {data/Sparse/ALM200.dat};
\addplot [mark=o,blue,dotted] table {data/Sparse/ALM300.dat};
\addplot [mark=o,green,dotted] table {data/Sparse/RPCA100.dat};
\addplot [mark=o,green,dotted] table {data/Sparse/RPCA200.dat};
\addplot [mark=o,green,dotted] table {data/Sparse/RPCA300.dat};
\addplot [mark=o,red,dotted] table {data/Sparse/SVD100.dat};
\addplot [mark=o,red,dotted] table {data/Sparse/SVD200.dat};
\addplot [mark=o,red,dotted] table {data/Sparse/SVD300.dat};
\end{axis}
\end{tikzpicture}
...
\addplot table {data/userGroup/ALM.dat};
\addplot table {data/userGroup/RPCA.dat};
\addplot table {data/userGroup/SVD.dat};
\end{axis}
\end{tikzpicture}
