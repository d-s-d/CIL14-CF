...
\cite{rpcapaper}: The less values are contained in the input matrix, the more
difficult it becomes to decompose it into a low-rank and a sparse component.\\

We also considered extending our user-hotel model to include an attacker.
