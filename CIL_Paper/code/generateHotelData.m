function [ data, modData ] = generateHotelData(user,hotel,no_user_groups,groups,attackers,sparse,attack_groups)
%GENERATEDATA Summary of this function goes here
%   This function generates user hotel data according to the paper
